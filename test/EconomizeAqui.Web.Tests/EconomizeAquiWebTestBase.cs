...
using EconomizeAqui.Models.TokenAuth;
...
{
    public abstract class EconomizeAquiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EconomizeAquiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EconomizeAquiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EconomizeAquiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EconomizeAquiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EconomizeAquiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EconomizeAquiDbContext, Task<T>> func)
        {
            T result;
